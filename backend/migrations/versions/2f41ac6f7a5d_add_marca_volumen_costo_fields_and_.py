...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'movimientos_inventario', 'lotes_costo', ['lote_costo_id'], ['id'], ondelete='SET NULL')
    ...
    op.create_foreign_key(None, 'productos', 'marcas', ['marca_id'], ['id'], ondelete='SET NULL')
