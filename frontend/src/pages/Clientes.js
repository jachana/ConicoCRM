...
export default function Clientes() {
    ...
    if (isLoading)
        return _jsx("div", { className: "p-6 text-gray-500 text-sm", children: "Cargando..." });
    return (_jsxs("div", { className: "p-4 md:p-6 max-w-6xl", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h1", { className: "text-xl font-semibold text-gray-900 dark:text-white", children: "Clientes" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => api.get('/api/clientes/export/excel', { responseType: 'blob' }).then(r => {
                                ...
                                }), className: "hidden sm:block px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors", children: "Exportar Excel" }), _jsx("button", { onClick: abrirCrear, className: "px-3 md:px-4 py-2 text-sm bg-brand-500 hover:bg-brand-400 text-gray-900 font-semibold rounded-lg transition-colors", children: "Agregar" })] })] }), _jsx("input", { type: "text", placeholder: "Buscar por nombre o RUT...", value: busqueda, onChange: e => setBusqueda(e.target.value), className: "mb-4 w-full max-w-sm px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500/40 focus:border-brand-500 outline-none" }), clientes.length === 0 ? (_jsx("div", { className: "text-gray-400 py-12 text-center text-sm", children: "Sin clientes registrados" })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "md:hidden space-y-2", children: clientes.map(c => (_jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4", children: [_jsxs("div", { className: "flex items-start justify-between gap-2", children: [_jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "font-semibold text-gray-900 dark:text-white text-sm truncate", children: c.nombre }), c.empresa?.nombre && (_jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 truncate mt-0.5", children: c.empresa.nombre })), _jsxs("div", { className: "flex flex-wrap gap-x-3 gap-y-0.5 mt-1.5", children: [c.rut && _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400 font-num", children: c.rut }), c.telefono && _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: c.telefono }), c.email && _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400 truncate", children: c.email })] })] }), _jsxs("div", { className: "flex gap-2 flex-shrink-0", children: [_jsx("button", { onClick: () => abrirEditar(c), className: "text-xs text-brand-600 dark:text-brand-400 font-medium hover:underline", children: "Editar" }), _jsx("button", { onClick: () => { setEliminandoId(c.id); setDeleteError(null); }, className: "text-xs text-red-500 hover:underline", children: "Borrar" })] })] }), eliminandoId === c.id && (_jsxs("div", { className: "mt-3 pt-3 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between text-xs", children: [deleteError
                                            ? _jsx("span", { className: "text-red-500", children: deleteError })
                                            : _jsx("span", { className: "text-gray-500 dark:text-gray-400", children: "\u00BFConfirmar eliminaci\u00F3n?" }), _jsxs("div", { className: "flex gap-3", children: [_jsx("button", { onClick: () => eliminar.mutate(c.id), disabled: eliminar.isPending, className: "text-red-600 font-semibold disabled:opacity-50", children: "S\u00ED" }), _jsx("button", { onClick: () => { setEliminandoId(null); setDeleteError(null); }, className: "text-gray-500", children: "No" })] })] }))] }, c.id))) }), _jsx("div", { className: "hidden md:block bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden", children: _jsxs("table", { className: "w-full text-sm", children: [_jsx("thead", { className: "bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide", children: _jsxs("tr", { children: [_jsx("th", { className: "text-left px-4 py-3 font-medium", children: "Nombre" }), _jsx("th", { className: "text-left px-4 py-3 font-medium", children: "Empresa" }), _jsx("th", { className: "text-left px-4 py-3 font-medium", children: "RUT" }), _jsx("th", { className: "text-left px-4 py-3 font-medium", children: "Email" }), _jsx("th", { className: "text-left px-4 py-3 font-medium", children: "Tel\u00E9fono" }), _jsx("th", { className: "text-left px-4 py-3 font-medium" })] }) }), _jsx("tbody", { className: "divide-y divide-gray-100 dark:divide-gray-800", children: clientes.map(c => (_jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors", children: [_jsx("td", { className: "px-4 py-3 font-medium text-gray-900 dark:text-white", children: c.nombre }), _jsx("td", { className: "px-4 py-3 text-gray-500 dark:text-gray-400", children: c.empresa?.nombre ?? '—' }), _jsx("td", { className: "px-4 py-3 text-gray-500 dark:text-gray-400 font-num", children: c.rut ?? '—' }), _jsx("td", { className: "px-4 py-3 text-gray-500 dark:text-gray-400", children: c.email ?? '—' }), _jsx("td", { className: "px-4 py-3 text-gray-500 dark:text-gray-400", children: c.telefono ?? '—' }), _jsx("td", { className: "px-4 py-3", children: eliminandoId === c.id ? (_jsxs("span", { className: "inline-flex items-center gap-2 text-xs", children: [deleteError
                                                            ? _jsx("span", { className: "text-red-500", children: deleteError })
                                                            : _jsx("span", { className: "text-gray-600 dark:text-gray-400", children: "\u00BFEliminar?" }), _jsx("button", { onClick: () => eliminar.mutate(c.id), disabled: eliminar.isPending, className: "text-red-600 hover:underline font-medium disabled:opacity-50", children: "S\u00ED" }), _jsx("button", { onClick: () => { setEliminandoId(null); setDeleteError(null); }, className: "text-gray-500 hover:underline", children: "No" })] })) : (_jsxs("span", { className: "inline-flex gap-3", children: [_jsx("button", { onClick: () => abrirEditar(c), className: "text-xs text-brand-600 dark:text-brand-400 hover:underline", children: "Editar" }), _jsx("button", { onClick: () => { setEliminandoId(c.id); setDeleteError(null); }, className: "text-xs text-red-500 hover:underline", children: "Eliminar" })] })) })] }, c.id))) })] }) })] })), modalOpen && (_jsx("div", { className: "fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4", children: _jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-xl w-full sm:max-w-2xl max-h-[92vh] overflow-y-auto", children: [_jsx("div", { className: "px-5 pt-5 pb-4 border-b border-gray-100 dark:border-gray-800 sticky top-0 bg-white dark:bg-gray-900 z-10", children: _jsx("h2", { className: "text-base font-semibold text-gray-900 dark:text-white", children: editando ? 'Editar cliente' : 'Nuevo cliente' }) }), _jsxs("form", { onSubmit: ev => { ev.preventDefault(); guardar.mutate(form); }, className: "px-5 py-4 grid grid-cols-2 gap-4", children: [_jsxs("div", { className: "col-span-2", children: [_jsx("label", { className: LABEL_CLS, children: "Empresa" }), _jsxs("select", { value: form.empresa_id ?? '', onChange: e => setForm(f => ({ ...f, empresa_id: e.target.value ? Number(e.target.value) : null })), className: INPUT_CLS, children: [_jsx("option", { value: "", children: "\u2014 Sin empresa \u2014" }), empresas.map(e => _jsx("option", { value: e.id, children: e.nombre }, e.id))] })] }), empresaSeleccionada && (_jsxs(_Fragment, { children: [empresaSeleccionada.rut && (_jsxs("div", { children: [_jsx("label", { className: LABEL_CLS, children: "RUT Empresa" }), _jsx("div", { className: READONLY_CLS, children: empresaSeleccionada.rut })] })), empresaSeleccionada.razon_social && (_jsxs("div", { children: [_jsx("label", { className: LABEL_CLS, children: "Raz\u00F3n Social" }), _jsx("div", { className: READONLY_CLS, children: empresaSeleccionada.razon_social })] }))] })), _jsxs("div", { className: "col-span-2", children: [_jsx("label", { className: LABEL_CLS, children: "Nombre *" }), _jsx("input", { type: "text", required: true, value: form.nombre, onChange: e => setForm(f => ({ ...f, nombre: e.target.value })), className: INPUT_CLS })] }), ([
