...
export default function CotizacionDetalle() {
    ...
    useEffect(() => {
        if (cotizacion) {
            ...
            setLineas((cotizacion.lineas ?? []).map((l, i) => ({
                ...l,
                _key: `${l.id ?? i}`,
