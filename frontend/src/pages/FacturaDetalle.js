...
export default function FacturaDetalle() {
    ...
    const deletePagoMut = useMutation({
        ...
        onError: (err) => setError(err?.response?.data?.detail || 'Error al eliminar pago'),
    });
