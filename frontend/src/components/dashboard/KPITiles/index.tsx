...
function VentasTile({ ventas }: { ventas: KpisOut['ventas'] }) {
  return (
    <TileShell accent="brand">
      ...
      {ventas.sparkline.length >= 2 && (
        <div className="mt-2 -mx-1" role="img" aria-label="Gráfico de ventas del mes">
          <ResponsiveContainer width="100%" height={50}>
            <AreaChart data={ventas.sparkline} margin={{ top: 2, right: 2, left: 2, bottom: 0 }}>
              <defs>
                <linearGradient id="kpi-ventas-fill-1" x1="0" y1="0" x2="0" y2="1">
