...
function RenderTopClientes({ data, chart }) {
    ...
    return (_jsx("div", { className: "overflow-auto h-full", children: _jsxs("table", { className: "w-full text-xs", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-gray-200 dark:border-gray-700", children: [_jsx("th", { className: "text-left py-1 px-2", children: "Cliente" }), _jsx("th", { className: "text-right py-1 px-2", children: "Total" })] }) }), _jsx("tbody", { children: data.map((r, i) => (_jsxs("tr", { className: "border-b border-gray-100 dark:border-gray-800", children: [_jsx("td", { className: "py-1 px-2 truncate max-w-[150px]", children: r.nombre }), _jsx("td", { className: "py-1 px-2 text-right", children: formatMoney(r.total) })] }, i))) })] }) }));
}
function RenderTopProductos({ data, chart }) {
    if (chart === 'bar')
        return _jsx(SimpleBarChart, { data: data, xKey: "nombre", yKey: "total" });
    return (_jsx("div", { className: "overflow-auto h-full", children: _jsxs("table", { className: "w-full text-xs", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-gray-200 dark:border-gray-700", children: [_jsx("th", { className: "text-left py-1 px-2", children: "Producto" }), _jsx("th", { className: "text-right py-1 px-2", children: "Cant." }), _jsx("th", { className: "text-right py-1 px-2", children: "Total" })] }) }), _jsx("tbody", { children: data.map((r, i) => (_jsxs("tr", { className: "border-b border-gray-100 dark:border-gray-800", children: [_jsx("td", { className: "py-1 px-2 truncate max-w-[120px]", children: r.nombre }), _jsx("td", { className: "py-1 px-2 text-right", children: r.cantidad }), _jsx("td", { className: "py-1 px-2 text-right", children: formatMoney(r.total) })] }, i))) })] }) }));
}
function RenderStockCritico({ data }) {
    return (_jsx("div", { className: "overflow-auto h-full", children: _jsxs("table", { className: "w-full text-xs", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-gray-200 dark:border-gray-700", children: [_jsx("th", { className: "text-left py-1 px-2", children: "Producto" }), _jsx("th", { className: "text-right py-1 px-2", children: "Actual" }), _jsx("th", { className: "text-right py-1 px-2", children: "M\u00EDnimo" })] }) }), _jsx("tbody", { children: data.map((r, i) => (_jsxs("tr", { className: "border-b border-gray-100 dark:border-gray-800", children: [_jsx("td", { className: "py-1 px-2 truncate max-w-[130px]", children: r.nombre }), _jsx("td", { className: "py-1 px-2 text-right text-red-600 font-medium", children: r.stock_actual }), _jsx("td", { className: "py-1 px-2 text-right text-gray-500", children: r.stock_minimo })] }, i))) })] }) }));
}
function RenderNVPorCobrar({ data, chart }) {
    if (chart === 'kpi')
        return (_jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-1", children: [_jsx("span", { className: "text-3xl font-bold text-orange-500", children: formatMoney(data.total_monto) }), _jsxs("span", { className: "text-xs text-gray-500", children: [data.count, " NV por cobrar"] })] }));
    return (_jsx("div", { className: "overflow-auto h-full", children: _jsxs("table", { className: "w-full text-xs", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-gray-200 dark:border-gray-700", children: [_jsx("th", { className: "text-left py-1 px-2", children: "NV" }), _jsx("th", { className: "text-left py-1 px-2", children: "Cliente" }), _jsx("th", { className: "text-right py-1 px-2", children: "Total" })] }) }), _jsx("tbody", { children: data.items.map((r, i) => (_jsxs("tr", { className: "border-b border-gray-100 dark:border-gray-800", children: [_jsxs("td", { className: "py-1 px-2", children: ["#", r.numero] }), _jsx("td", { className: "py-1 px-2 truncate max-w-[120px]", children: r.cliente }), _jsx("td", { className: "py-1 px-2 text-right", children: formatMoney(r.total) })] }, i))) })] }) }));
}
function RenderVendedorMetrica({ data, chart }) {
    if (chart === 'bar')
        return _jsx(SimpleBarChart, { data: data, xKey: "nombre", yKey: "total" });
    return (_jsx("div", { className: "overflow-auto h-full", children: _jsxs("table", { className: "w-full text-xs", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-gray-200 dark:border-gray-700", children: [_jsx("th", { className: "text-left py-1 px-2", children: "Vendedor" }), _jsx("th", { className: "text-right py-1 px-2", children: "Docs" }), _jsx("th", { className: "text-right py-1 px-2", children: "Total" })] }) }), _jsx("tbody", { children: data.map((r, i) => (_jsxs("tr", { className: "border-b border-gray-100 dark:border-gray-800", children: [_jsx("td", { className: "py-1 px-2", children: r.nombre }), _jsx("td", { className: "py-1 px-2 text-right", children: r.count }), _jsx("td", { className: "py-1 px-2 text-right", children: formatMoney(r.total) })] }, i))) })] }) }));
}
