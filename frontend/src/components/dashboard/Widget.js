...
function KpiCard({ value, label }) {
    return (_jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-1 px-2", children: [_jsx("span", { className: "text-3xl font-bold text-blue-500 dark:text-blue-400 w-full text-center break-all leading-tight", children: value }), _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400 text-center", children: label })] }));
}
...
function RenderNVPorCobrar({ data, chart }) {
    if (chart === 'kpi')
        return (_jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-1 px-2", children: [_jsx("span", { className: "text-3xl font-bold text-orange-500 dark:text-orange-400 w-full text-center break-all leading-tight", children: formatMoney(data.total_monto) }), _jsxs("span", { className: "text-xs text-gray-500 dark:text-gray-400 text-center", children: [data.count, " NV por cobrar"] })] }));
