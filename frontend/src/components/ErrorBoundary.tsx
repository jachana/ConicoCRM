  ...
  render() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-4 p-8 text-center">
        ...
        >
          <h2 className="text-danger-700 dark:text-danger-400 font-semibold mb-2">Error inesperado</h2>
          <p className="text-sm text-danger-600 dark:text-danger-300 font-mono break-all">{error.message}</p>
          {error.stack && (
          ...
          <button
            className="mt-4 px-4 py-2 text-sm rounded-md bg-danger-600 text-white hover:bg-danger-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-danger-500"
