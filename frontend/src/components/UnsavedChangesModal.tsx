      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            disabled={saving}
            className="w-full px-4 py-2 text-sm font-medium bg-info-600 text-white rounded-lg hover:bg-info-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
          >
